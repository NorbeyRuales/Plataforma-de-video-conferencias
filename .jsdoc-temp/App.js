...
export default function App() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("a", { href: "#main-content", className: "skip-link", children: "Skip to main content" }), _jsx(AppHeader, { isAuthenticated: isAuthenticated, onLogout: handleLogout }), _jsx(TopLoadingBar, {}), _jsx(Breadcrumbs, {}), _jsx("main", { id: "main-content", tabIndex: -1, children: _jsxs(Routes, { children: [_jsx(Route, { path: "/", element: _jsx(HomePage, {}) }), _jsx(Route, { path: "/about", element: _jsx(AboutPage, {}) }), _jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/register", element: _jsx(RegisterPage, {}) }), _jsx(Route, { path: "/forgot-password", element: _jsx(ForgotPasswordPage, {}) }), _jsx(Route, { path: "/reset-password", element: _jsx(ResetPasswordPage, {}) }), _jsx(Route, { path: "/privacy", element: _jsx(PrivacyPage, {}) }), _jsx(Route, { path: "/data-deletion", element: _jsx(DataDeletionPage, {}) }), _jsx(Route, { path: "/account", element: isAuthenticated ? _jsx(AccountPage, {}) : _jsx(Navigate, { to: "/login", replace: true }) }), _jsx(Route, { path: "/meetings/new", element: isAuthenticated ? (_jsx(CreateMeetingPage, {})) : (_jsx(Navigate, { to: "/login", replace: true })) }), _jsx(Route, { path: "/sitemap", element: _jsx(SitemapPage, {}) }), _jsx(Route, { path: "/meeting/:meetingId", element: _jsx(MeetingRoomPage, {}) }), _jsx(Route, { path: "*", element: _jsx(NotFoundPage, {}) })] }) }), _jsx(AppFooter, {})] }));
}
