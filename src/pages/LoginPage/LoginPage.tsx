...
/**
 * Login page UI with email/password and social (Google/GitHub) sign-in.
 *
 * @returns {JSX.Element} Authentication form for returning users.
 */
export function LoginPage(): JSX.Element {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const message =
        ...
        'No se pudo iniciar sesión. Revisa el correo y la contraseña o usa Olvidaste tu contraseña.';
      setLoginErrorMessage('Revisa correo y contraseña o restablécela si la olvidaste.');
  ...
  /**
   * Initiates OAuth login with the selected provider.
   */
