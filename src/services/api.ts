...
/**
 * Options accepted by the internal API fetch helper.
 */
interface ApiOptions<TBody = unknown> {
  ...
  body?: TBody;
  /** Optional override for the bearer token. */
...
/** Shape of the authenticated user's profile as returned by the API. */
...
/** Meeting entity returned by the backend. */
...
/** Payload used to create a meeting. */
